# [Platinum II] 컨닝 2 - 11014 

[문제 링크](https://www.acmicpc.net/problem/11014) 

### 성능 요약

메모리: 2772 KB, 시간: 36 ms
...
<p style="text-align:center"><img alt="" src="" style="height:124px; width:183px"></p>
...
<p>위와 같이 컨닝이 불가능하도록 자리를 배치 하려는 최백준의 행동에 분노한 일부 학생들이 교실의 책상을 부셔버렸기 때문에, 일부 자리에는 학생이 앉을 수 없다.</p>
...
<p>첫 번째 부분에서는 교실의 세로길이 N과 가로길이 M이 한 줄에 주어진다. (1 ≤ M ≤ 80, 1 ≤ N ≤ 80)</p>
